...
def admin_panel():
    ...
    return render_template('admin_panel.html', mangas=mangas, chapter_count=chapters, request=request)
...
async def admin_add():
    ...
    return redirect(url_for('admin.admin_panel', token=request.args.get('token')))
